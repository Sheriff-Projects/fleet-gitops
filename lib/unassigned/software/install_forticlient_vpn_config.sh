...
#
# Built on 2026-05-15 02:03:15
# PKG version: 2026.05.15.020315

set -uo pipefail

PKG_URL="https://raw.githubusercontent.com/souari1974/fleet-gitops/main/lib/unassigned/download/forticlient_vpn_config.pkg"
TEMP_DIR=$(mktemp -d)
